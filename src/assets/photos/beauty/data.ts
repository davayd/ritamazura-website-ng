    ...
    [
      {
        ...
        sizes: {
          ...
          desktop: { width: 1000, height: 1297 },
        },
        label: `8 Julia David-${imageMode}.webp`,
      },
      {
        url: `/assets/photos/beauty/8.1 Julia David-${imageMode}.webp`,
        sizes: {
          mobile: { width: 500, height: 649 },
          desktop: { width: 1000, height: 1297 },
        },
        label: `8.1 Julia David-${imageMode}.webp`,
      },
    ],
    [
      {
