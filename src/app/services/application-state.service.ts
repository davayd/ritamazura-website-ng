...
export class ApplicationStateService {
  ...
  constructor(private _breakpointObserver: BreakpointObserver) {
    ...
    this.photographySessions = this.generatePhotographySessions(imageMode);

    this.retouchSessions = this.generateRetouchSessions(imageMode);
  }

  private generatePhotographySessions(
    imageMode: ImageMode
  ): PhotographySession[] {
    const s1 = new PhotographySession('Session 1', 'session-1', [
      ...
      // {
      //   url: `https://picsum.photos/1000/1000?au`,
      // },
    ]);
    ...
    // {
    //   title: 'Session 1',
    //   transliteratedUrl: 'session-1',
    //   photos: [
    //     {
    //       url: `/assets/photos/34-${imageMode}.jpg`,
    //     },
    //     {
    //       url: `/assets/photos/DSC00908-${imageMode}.jpg`,
    //     },
    //     {
    //       url: `/assets/photos/DSC01152-${imageMode}.jpg`,
    //     },
    //   ],
  ...
  private generateRetouchSessions(imageMode: ImageMode) {
    return [];
  }
}
